...
- **Component Naming:** Use the filename as the component name. For example, ReservationCard.tsx should have a reference name of ReservationCard. However, for root components of a directory, use iamport.tsx as the filename and use the directory name as the component name:
